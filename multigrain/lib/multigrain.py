...
model_urls = {
    ('multigrain_resnet50'): '',
    ('multigrain_pnasnet5large'): 'https://dl.fbaipublicfiles.com/multigrain/finetuned_models/pnasnet5large-finetune500.pth',
    ('multigrain_senet154'): 'https://dl.fbaipublicfiles.com/multigrain/finetuned_models/senet154-finetune400.pth',
}
...
class MultiGrain(BackBone):
    ...
    def forward(self, input, instance_target=None, **kwargs):
        ...
        return output_dict['classifier_output']
